...
public class Jwt {
	...
	public static String createToken(Long userId) {
		...
		payload.put("ext", date.getTime() + 1000*24*60*60);// 过期时间24小时
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(10000);
		JwtResult result = checkToken(token);
		
		System.out.println(result.getState() + "," + result.getData() + "," + result.getUserId());
